...
class AccountTests: XCTestCase {
    func testAccountFromJSON() {
        ...
        XCTAssertEqual(account?.avatar, URL(string: "http://lorempixel.com/200/200/cats/3/"))
        XCTAssertEqual(account?.avatarStatic, URL(string: "http://lorempixel.com/300/300/cats/3/"))
        XCTAssertEqual(account?.header, URL(string: "http://lorempixel.com/700/300/cats/1/"))
        XCTAssertEqual(account?.headerStatic, URL(string: "http://lorempixel.com/800/400/cats/1/"))
